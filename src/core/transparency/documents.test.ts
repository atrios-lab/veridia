...
test("category guard accepts the fixed list and rejects free text", () => {
  ...
  // Anexo II do Provimento CGJ/TJRN n. 7/2026: o cartaz das hipóteses de
  // gratuidade e isenção é publicado como qualquer outro documento de
  // transparência, pela categoria fixa.
