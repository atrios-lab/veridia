 ...
 * shows nine items across three groups, and three of them (Atendimento
 * online, Publicações, Usuários) point at screens this repository does not
 * have yet: a menu entry that leads to a 404 spends more of the registrar's
 * trust than a short sidebar saves. Each delivery adds its own line here
