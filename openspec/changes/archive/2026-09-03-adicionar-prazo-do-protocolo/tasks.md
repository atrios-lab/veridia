...
- [x] 7.2 Verificar no navegador pelo host do cartório (majorsales.localhost): certidão (5 dias úteis) prevê 04/09 e registro na matrícula (10 dias úteis) prevê 14/09, pulando o feriado de 07/09 ✅; consulta mostra a contagem e a ressalva da ordem de chegada ✅. Com login no painel: controle de prazo mostra "até 14/09/2026 · 10 dias úteis", ajuste para 20 dias e "recomeçar hoje" gravam junto com o andamento e aparecem no histórico como "ajustou o prazo" ✅; em Configurações, salvar 12 passa a valer para escritura (16/09) e a certidão segue no prazo legal (04/09), e o servidor recusa 400 dias ✅. Pedidos e override de teste apagados do banco depois, com auditoria.
