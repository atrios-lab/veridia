...
aparência do painel (cores, tipografia, espaçamento) SHALL ser fixa da plataforma e SHALL NOT
variar conforme o tema de marca configurado para a serventia.
...
#### Scenario: Duas serventias, mesma estética
- **WHEN** `/admin/login` é aberto em domínios de duas serventias com temas de marca diferentes
- **THEN** as cores e a tipografia do painel de login são idênticas nas duas; só o selo, o nome
  e o subtítulo mudam
