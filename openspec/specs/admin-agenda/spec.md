# admin-agenda Specification

## Purpose
A agenda de atendimentos no painel: o dia a dia da serventia sobre os horários que o site
oferece. Cobre a agenda do dia (quem vem, horários livres, reserva de balcão, atendido, falta e
cancelamento), o fechamento e a reabertura de datas, e a configuração da grade semanal, dos
serviços e dos modos de atendimento. O lado público do agendamento vive em
